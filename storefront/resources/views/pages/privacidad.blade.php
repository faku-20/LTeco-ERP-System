...
@section('title','Política de privacidad | ERP')
@section('description','Cómo ERP trata y protege los datos personales de sus clientes.')
@section('content')
...
<section><h2>Responsable y alcance</h2><p>ERP es responsable del tratamiento de los datos utilizados para administrar esta tienda, las cuentas de clientes, las compras, la facturación, la entrega, la garantía, los servicios técnicos y la atención posventa.</p></section>
