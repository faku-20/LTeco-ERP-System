...
@section('title','Agendar visita | CommerceOps')
@section('description','Solicitá una visita coordinada con CommerceOps en zona Belvedere. Coordinación previa obligatoria.')
...
<section class="visit-booking"><div class="phase1-container visit-booking__grid">
    <header class="visit-booking__intro">
        ...
        <div class="visit-booking__notice"><strong>Atención con agenda previa</strong><span>No concurras sin confirmación del equipo de CommerceOps.</span></div>
    </header>
    <form class="visit-booking__form" method="POST" action="{{ route('visits.store') }}">@csrf
        ...
        <label class="visit-booking__privacy"><input type="checkbox" name="accept_privacy" value="1" required> Acepto que CommerceOps use estos datos para coordinar la visita, según la <a href="{{ route('privacidad') }}">política de privacidad</a>.</label>
